...
test.describe.serial('Motadata ObserveOps APM Trace Metric Policy creation', () => {
  ...
  test('Go to Metric Policy and create a new policy', async () => {
    ...
    const tags = ['motadata:8.61', 'Automation@anant', 'sp@#$%^^&*()sp'];
    ...
    await page.locator("//input[@placeholder='@User or Email or /Handle or #User Profile or !syslog profile or SNMP trap Profile']").type('anant.awishkar@motadata.com\n');
