...
## Navigation
Route: `/settings/log-settings/log-collection-profile` (open the full URL; SPA routing must load the page).
...
_Locators: see `knowledge/locators/catalog/settings_log_settings_log_collection_profile.json` (raw sweep) — promote verified ones into the cookbook._
